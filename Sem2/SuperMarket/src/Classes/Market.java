...
public class Market implements iMarketBehaviour,iQueueBehaviour {
    ...
    private List<iActorBehaviour> retqueue;
    ...
    public void takeOrder() {
        ...
        public void takeReturnQueue(Actor actor) {
        this.retqueue.add(actor);  // добавляем очередь
        System.out.println(actor.getName() + " клиент добавлен в очередь возврата товара");
    }

    public void returnOrder() {  // возврат заказа
